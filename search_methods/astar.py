...
from environments.nm_puzzle import NMPuzzleState
...
def main():
    ...
    parser.add_argument('--user_entry', action='store_true', default=False, help="Solve state from user console")
...
# TODO sistemare le 2 funzioni in nm_puzzle
...
def entry_user_state() -> List[State]:
    ...
    return [NMPuzzleState(load_state(init_state))]
